...
const projects = Array.from({ length: 6 }, (_, repeatIndex) => (
  projectsData.map((project, index) => ({
    ...project,
    id: repeatIndex * projectsData.length + index + 1,
  }))
)).flat();
                ...
                <div className="pagination-numbers">
                  {generatePageNumbers().map((pageNumber) => (
                    <button
                      ...
                      className={`pagination-number ${safeCurrentPage === pageNumber ? 'active' : ''}`}
                    >
                      {pageNumber}
                    </button>
                  ))}
