  ...
  return (
    <div className="about">
      ...
      <div className="content">
        ...
        <a href="https://drive.google.com/file/d/1BXEYnOjuZAIBEacxZVJwzMFUm7Tz0QNS/view?usp=sharing" target='_blank' rel="noopener noreferrer"><button className='p-text'>Download CV</button></a>
      </div>
