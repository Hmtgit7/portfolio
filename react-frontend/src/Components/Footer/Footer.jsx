...
const Footer = () => {
  return (
    <div className="footer">
      <div className="icons">
      <a href='https://github.com/Hmtgit7' target="_blank" rel="noreferrer">
        <div>
          <BsGithub />
        </div></a>
      ...
      <div className="content">
        <h1>Made with❤️ <a href='https://github.com/Hmtgit7' target="_blank" rel="noreferrer">Spark Developie</a> Copyright @2023</h1>
      </div>
    </div>
  )
}
