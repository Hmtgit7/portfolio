  ...
  return (
    <div className="about">
      ...
      <div className="content">
        ...
        <a href="https://drive.google.com/file/d/1aMOMqqITHqXOQKpBSoTfPMXvYZ4Yp6YR/view?usp=sharing" target='_blank' rel="noreferrer"><button className='p-text'>Download CV</button></a>
      </div>
